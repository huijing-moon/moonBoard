...
<h5>수정하기</h5>
<div>
<form name="update" action="/board/save" method="POST" return="false">
    ...
    <button type="button" class="btn btn-danger"><a href="/board/delete/${id}" onclick="confirm('정말로 삭제하시겠습니까?')">삭제</a> </button>
